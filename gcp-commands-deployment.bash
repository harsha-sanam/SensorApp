...
gcloud compute ssh sensor-app-vm --zone=us-central1-c --command "cd SensorApp; docker-compose down; docker rm -f $(docker ps -aq);docker rmi -f $(docker images -aq);docker builder prune -a -f; docker-compose build --no-cache;docker-compose up -d;"
